        ...
        if(data.status){
            ...
            <div class="controls">
                 <select name='gid'>
                    ...
                    <?php if(is_array($gym)): $i = 0; $__LIST__ = $gym;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
         <div class="form-item">
            ...
            <div class="controls">
                 <select name='stid'>
                     <option value='0'>请选择</option>
                    <?php if(is_array($sportType)): $i = 0; $__LIST__ = $sportType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="controls">
                <select name="openzone_s" class="openzone_s">
                  <?php if(is_array($showtime)): $i = 0; $__LIST__ = $showtime;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["value"]); ?>" ><?php echo ($vo["value"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>——
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <select name="orderconfigid">
                    <option value='0'>请选择</option>
                <?php if(is_array($orderConfig)): $i = 0; $__LIST__ = $orderConfig;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" >最低<?php echo ($vo["minhour"]); ?>小时-最多<?php echo ($vo["maxhour"]); ?>小时--最多<?php echo ($vo["maxplace"]); ?>个场地</option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="controls">
             <select name="priceconfigid" id="priceconfigid">
                 <option value="0">请选择</option>
                <?php if(is_array($priceConfig)): $i = 0; $__LIST__ = $priceConfig;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" ><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>  
            </select>
