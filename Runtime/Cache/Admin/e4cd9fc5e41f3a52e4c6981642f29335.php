...
<body>
  ...
  <script type="text/javascript" src="/Public/static/uploadify/jquery.uploadify.min.js"></script>
    ...
    <form action="<?php echo U(Sport/sportTypeEdit);?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">名称<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="name" value="<?php echo ($sportType["name"]); ?>">
            </div>
        </div>
        <input type='hidden' value='<?php echo ($sportType["id"]); ?>' name='sportTypeId'>
             <div class="form-item">
            ...
            <img src='<?php echo ($sportType["icon"]); ?>'>
...
/* 初始化上传插件 */
    ...
    function uploadPicturelogo(file, data){
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="sort" value="<?php echo ($sportType["sort"]); ?>">
            </div>
        </div>
