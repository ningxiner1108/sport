...
class CommonController extends Controller
{
    ...
    {
        //$_SESSION['uid'] = null;
        //$_SESSION['openid'] = 'oKoKNtz07JZcK2SobdqDdtjrq6QM';
    ...
    public function getWxLogin()
    {
        ...
        $fComeGoNo = I('get.fComeGoNo');
        $appid     = I('get.appid');

        //$this->redirect('/Mobile/OAuth/wxUserInfo/wxappid/'.$appid.'/state/'.$fComeGoNo);
        $this->redirect('/Mobile/OAuth/wxUserBase/wxappid/'.$appid.'/state/'.$fComeGoNo);
    }
    ...
    public function wxPayPost($money, $out_trade_no, $body = '您的缴费信息')
    {
        ...
        $unifiedOrder->setParameter("total_fee", $money * 100);//总金额 转化为分
        $unifiedOrder->setParameter("notify_url", "http://sport.24parking.com.cn/index.php/Mobile/WxPay/notify");//通知地址//WxPayConf_pub::NOTIFY_URL
        $unifiedOrder->setParameter("trade_type", "JSAPI");//交易类型
